    ...
    t.extend(t.fn, {
        ...
        rules: function(e, i) {
            ...
            if (null != d && (!d.form && d.hasAttribute("contenteditable") && (d.form = this.closest("form")[0], d.name = this.attr("name")), null != d.form)) {
                ...
                return r = t.validator.normalizeRules(t.extend({}, t.validator.classRules(d), t.validator.attributeRules(d), t.validator.dataRules(d), t.validator.staticRules(d)), d), r.required && (o = r.required, delete r.required, r = t.extend({
                    required: o
        ...
        prototype: {
            ...
            element: function(e) {
                var i, s, n = this.clean(e),
                    ...
                    r = this,
                    o = !0;
                return void 0 === a ? delete this.invalid[n.name] : (this.prepareElement(a), this.currentElements = t(a), s = this.groups[a.name], s && t.each(this.groups, function(t, e) {
                    e === s && t !== a.name && (n = r.validationTargetFor(r.clean(r.findByName(t))), n && n.name in r.invalid && (r.currentElements.push(n), o = r.check(n) && o))
                }), i = this.check(a) !== !1, o = o && i, i ? this.invalid[a.name] = !1 : this.invalid[a.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), t(e).attr("aria-invalid", !i)), o
            },
            ...
            elementValue: function(e) {
                var i, s, n = t(e),
                    a = e.type;
                return "radio" === a || "checkbox" === a ? this.findByName(e.name).filter(":checked").val() : "number" === a && "undefined" != typeof e.validity ? e.validity.badInput ? "NaN" : n.val() : (i = e.hasAttribute("contenteditable") ? n.text() : n.val(), "file" === a ? "C:\\fakepath\\" === i.substr(0, 12) ? i.substr(12) : (s = i.lastIndexOf("https://mdbootstrap.com/"), s >= 0 ? i.substr(s + 1) : (s = i.lastIndexOf("\\"), s >= 0 ? i.substr(s + 1) : i)) : "string" == typeof i ? i.replace(/\r/g, "") : i)
            },
            check: function(e) {
                e = this.validationTargetFor(this.clean(e));
                var i, s, n, a, r = t(e).rules(),
            ...
            showLabel: function(e, i) {
                var s, n, a, r, o = this.errorsFor(e),
                    l = this.idOrName(e),
                    d = t(e).attr("aria-describedby");
                o.length ? (o.removeClass(this.settings.validClass).addClass(this.settings.errorClass), o.html(i)) : (o = t("<" + this.settings.errorElement + ">").attr("id", l + "-error").addClass(this.settings.errorClass).html(i || ""), s = o, this.settings.wrapper && (s = o.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(s) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, s, t(e)) : s.insertAfter(e), o.is("label") ? o.attr("for", l) : 0 === o.parents("label[for='" + this.escapeCssMeta(l) + "']").length && (a = o.attr("id"), d ? d.match(new RegExp("\\b" + this.escapeCssMeta(a) + "\\b")) || (d += " " + a) : d = a, t(e).attr("aria-describedby", d), n = this.groups[e.name], n && (r = this, t.each(r.groups, function(e, i) {
        ...
        methods: {
            ...
            remote: function(e, i, s, n) {
                ...
                return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[i.name][n], this.settings.messages[i.name][n] = l.message, s = "string" == typeof s && {
                    ...
                    data: e
                }, s.data)), l.old === o ? l.valid : (l.old = o, a = this, this.startRequest(i), r = {}, r[i.name] = e, t.ajax(t.extend(!0, {
                    mode: "abort",
                    ...
                    success: function(t) {
                        var s, r, o, d = t === !0 || "true" === t;
                        a.settings.messages[i.name][n] = l.originalMessage, d ? (o = a.formSubmitted, a.resetInternals(), a.toHide = a.errorsFor(i), a.formSubmitted = o, a.successList.push(i), a.invalid[i.name] = !1, a.showErrors()) : (s = {}, r = t || a.defaultMessage(i, {
                            method: n,
                            parameters: e
...
$.fn.isValid = function() {
    ...
    return n.parallel && $(r).validateStep() || !n.parallel && a.isValid() ? l && e ? (n.showFeedbackLoader && s.activateFeedback(), window[l].call()) : (r.removeClass("wrong").addClass("done"), this.openStep(o, t), this.trigger("nextstep")) : r.removeClass("done").addClass("wrong")
    ...
    if (t = this.find(".step:visible:eq(" + n + ")"), !t.hasClass("active")) {
        var a, r = this.find(".step.active"),
            o = a = $(this.children(".step:visible")).index($(r)),
            l = n > o ? 1 : 0;
        r.hasClass("feedbacking") && s.destroyFeedback(), r.closeAction(l), t.openAction(l, function() {
    ...
    if (window.innerWidth < 993 || !this.closest("ul").hasClass("horizontal") ? i.stop().slideUp(300, "easeOutQuad", e) : 1 == t ? i.animate({
            left: "-100%"
        }, function() {
            i.css({
                display: "none",
    ...
    if (window.innerWidth < 993 || !this.closest("ul").hasClass("horizontal") ? i.slideDown(300, "easeOutQuad", e) : 1 == t ? i.css({
            left: "100%",
            display: "block"
        }).animate({
            left: "0%"
    ...
    var t = !0;
    return validation && $(this).find("input.validate").each(function() {
